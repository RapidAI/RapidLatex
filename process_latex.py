...
# Math environments that should NOT be translated
math_environments = ['equation', 'align', 'gather', 'displaymath', 'eqnarray', 'multline', 'flalign', 'alignat', 'cases', 'matrix', 'bmatrix', 'pmatrix', 'vmatrix', 'Vmatrix']
